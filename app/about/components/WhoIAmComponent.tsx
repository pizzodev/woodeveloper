    ...
    return (
        <section className="flex flex-col flex-1 justify-between mx-auto max-w-7xl px-6 py-8 text-center">
            ...
            <button
                ...
                className="mt-auto px-6 py-4 rounded-xl border border-zinc-200 dark:border-zinc-700 text-base font-semibold text-white dark:text-white hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all duration-200"
            >
                Le mie creazioni
            </button>
        </section>
